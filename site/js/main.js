...
(function () {
  ...
  function attachBasicChatHandlers() {
    ...
    var ANSWERS = {
      ...
      'Certifications?': 'Sriyogya holds certifications from Cornell University, NUS School of Computing (AI-Powered Business Analytics), AI Student of the Year — Top 5 (Mahindra × Google Gemini), the Fintenship Program, and UNITAR UN CC:Learn. See the <a href="certifications.html" class="underline text-[#6e56cf]">Certifications</a> page!',
      'Extracurriculars?': 'Sriyogya has led a clothing donation drive with Share At Door Step, a vaccination & medical drive in rural Andhra Pradesh, been recognised as a Student Leader in Mahindra University\'s Global Immersion Programme (June 2025), and run a food distribution drive with the Veerabhadra Trust. See <a href="extracurricular.html" class="underline text-[#6e56cf]">Extra-Curricular</a> for details.',
      'Resume highlights?': 'Highlights: NUS Commendation Award (top 20%), AI Student of the Year Top 5, Cornell University immersion, 6 applied projects (analytics, UX, IoT, marketing), and community leadership across multiple initiatives. Visit the <a href="resume.html" class="underline text-[#6e56cf]">Resume</a> page for the full picture.'
    };
